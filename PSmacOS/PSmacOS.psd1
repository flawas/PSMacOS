@{
    ...
    GUID = '1f311e3a-a8a9-473f-ab98-436790396eff'
    ...
    Copyright = 'Copyright (c) 2026 by Flavio Waser. Licensed under MIT license.'

    # Description of the functionality provided by this module
    Description = 'PowerShell module with custom functions and cmdlets to manage macOS system settings, starting with the local host name (ComputerName, LocalHostName and HostName).'
